import{e as w,n as f,W as p,B as v,i as b,T as g,b as u,a as y,l as a}from"./wired-base-02cb0b5c.js";var o=globalThis&&globalThis.__decorate||function(d,i,s,r){var t=arguments.length,e=t<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,s):r,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(d,i,s,r);else for(var l=d.length-1;l>=0;l--)(h=d[l])&&(e=(t<3?h(e):t>3?h(i,s,e):h(i,s))||e);return t>3&&e&&Object.defineProperty(i,s,e),e},c=globalThis&&globalThis.__metadata||function(d,i){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(d,i)};let n=class extends p{constructor(){super();this.elevation=1,this.roAttached=!1,window.ResizeObserver&&(this.resizeObserver=new window.ResizeObserver(()=>{this.svg&&this.wiredRender()}))}static get styles(){return[v,b`
        :host {
